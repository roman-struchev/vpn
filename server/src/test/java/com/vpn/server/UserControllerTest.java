...
class UserControllerTest {
    ...
    void testGetRegionsSuccess() {
        when(exportService.getAvailableRegions(10L)).thenReturn(List.of(
                new SubscriptionExportService.RegionSummary("nl-ams", 2, 35.5, 40L, 5_000_000.0, 41.0, "LOW"),
                new SubscriptionExportService.RegionSummary("us-lax", 1, 88.0, 120L, 60_000_000.0, 70.0, "HIGH")
        ));
