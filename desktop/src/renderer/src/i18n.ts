...
const translations = {
  ru: {
    ...
    updateInstallAction: 'Перезапустить',
    updateDownloadAction: 'Скачать',
    updateLater: 'Позже',
    updateHintScript: 'Приложение скачает её, заменит себя и перезапустится. VPN на это время отключится.',
    updateHintInstall: 'Уже скачана — установится при перезапуске. VPN на это время отключится.',
    updateHintManual: 'Скачайте новую версию со страницы релизов.',
    updateDownloading: 'Скачиваем обновление… {percent}%',
    updateDownloadingNoPercent: 'Скачиваем обновление…',
    updateInstalling: 'Устанавливаем…',
    updateFailed: 'Не удалось обновиться. Попробуйте ещё раз или скачайте со страницы релизов.',
  ...
  en: {
    ...
    updateLater: 'Later',
    updateHintScript: 'The app will download it, replace itself and restart. The VPN disconnects meanwhile.',
    updateHintInstall: 'Already downloaded — installs on restart. The VPN disconnects meanwhile.',
    updateHintManual: 'Download the new version from the releases page.',
    updateDownloading: 'Downloading the update… {percent}%',
    updateDownloadingNoPercent: 'Downloading the update…',
    updateInstalling: 'Installing…',
    updateFailed: 'The update failed. Try again, or download it from the releases page.',
