...
NextGen VPN использует многоуровневую транспортную стратегию, разработанную на основе глубоких исследований поведения российских комплексов ТСПУ (Технические средства противодействия угрозам) и зарубежных систем DPI (Китай, Иран).
...
Чтобы клиенты NextGen VPN не загоняли себя в 10-минутную ловушку ТСПУ, в Android и Desktop клиентах реализован алгоритм умной паузы:
...
Клиент NextGen VPN периодически выполняет проверку:
