...
export const adminApi = {
  ...
  /** Pool is the single lever for tariff access now (docs/research/P2P_RELAY_FEASIBILITY.md §8.3) — the server re-derives availableToTrial/availableToPaid from it on every change. */
