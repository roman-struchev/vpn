...
| Тариф | В месяц | За год (−20%) | Трафик/мес | Устройств | Серверы |
|---|---|---|---|---|---|
| Пробный | 0 | — | 1 ГБ | 1 | общие, с общим потолком канала |
| Basic | $1 | $9.6 | 20 ГБ | 2 | обычные |
| Pro | $2 | $19.2 | 100 ГБ | 5 | приоритетные, скорость не ограничена |
...
**Годовая подписка со скидкой 20% решает сразу три задачи:** снижает частоту платежей там, где нет автосписания; делает Ethereum mainnet экономически осмысленным (комиссия $1–10 терпима при чеке $19.2, но абсурдна при $2); и даёт предоплату вперёд.
